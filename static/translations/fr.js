...
I18n.register('fr', {
    ...
    // === QUALITÉ DE L'AIR ===
    AQ_LABEL: "Qualité de l'air",
    AQ_INDOOR: 'Intérieur',
    AQ_OUTDOOR: 'Extérieur',
    AQ_INDOOR_SHORT: 'Int',
    AQ_OUTDOOR_SHORT: 'Ext',
    AQI_BAND_good: 'Bon',
    AQI_BAND_fair: 'Moyen',
    AQI_BAND_moderate: 'Dégradé',
    AQI_BAND_poor: 'Mauvais',
    AQI_BAND_very_poor: 'Très mauvais',
    AQI_BAND_extremely_poor: 'Extrêmement mauvais'
});
