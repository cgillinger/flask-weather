# 🌤️ Flask Weather Dashboard - Complete Guide
...
A modern, responsive weather dashboard that works on all screen sizes and devices. Shows weather forecasts from SMHI, YR/met.no or Open-Meteo (global coverage), with optional Netatmo weather station integration for actual measurements. Includes Weather Effects with animated rain and snow, UV index from CAMS, eight UI languages, and centralized color management.
...
- **Configuration**: `reference/config_example.py` has detailed comments
